  ...
  const navLinkClass = (href: string) => {
    ...
    return [
      ...
      active
        ...
        ? "text-[var(--header-fg)] dark:text-fg"
  ...
  return (
    ...
    <header className="sticky top-0 z-50 border-b border-transparent bg-[var(--header)] dark:border-line dark:bg-[var(--header)] dark:backdrop-blur-md dark:supports-[backdrop-filter]:bg-[var(--header)]">
      ...
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between gap-6 px-4 sm:px-6">
        ...
        <div className="hidden items-center gap-2 lg:flex">
          ...
          <Button
            ...
            className="border-transparent text-[var(--header-muted)] hover:border-white/20 hover:bg-white/10 hover:text-[var(--header-fg)] dark:text-muted dark:hover:border-line dark:hover:bg-[var(--card-hover)] dark:hover:text-fg"
        ...
        <button
          ...
          className="inline-flex h-10 w-10 items-center justify-center rounded-lg border border-white/25 bg-white/10 text-[var(--header-fg)] transition-colors hover:bg-white/15 dark:border-line dark:bg-card dark:text-fg dark:hover:bg-[var(--card-hover)] lg:hidden"
      ...
      <div
        ...
        className="border-t border-black/5 bg-white dark:hidden"

        aria-label="Section shortcuts"

      >

        <div className="mx-auto flex h-[var(--subnav-h)] max-w-7xl items-center gap-6 overflow-x-auto px-4 text-sm sm:px-6">
        ...
        <div className="border-t border-white/15 bg-[var(--header)] dark:border-line dark:bg-ink lg:hidden">
          ...
          <nav className="mx-auto flex max-w-7xl flex-col px-4 py-4" aria-label="Mobile">
            ...
            <Link
              ...
              className="rounded-lg px-3 py-3 text-sm font-medium text-[var(--header-muted)] transition-colors hover:bg-white/10 hover:text-[var(--header-fg)] dark:text-muted dark:hover:bg-[var(--card-hover)] dark:hover:text-fg"
